        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
          <thead>
            <tr style={{ background: 'var(--bg-surface-hover)', color: 'var(--text-tertiary)', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
              <th style={{ padding: '1rem', borderBottom: '1px solid var(--border-light)' }}>F. Aprobación</th>
              <th style={{ padding: '1rem', borderBottom: '1px solid var(--border-light)' }}>N° Presup.</th>
          ...
          <tbody>
            {obras.length === 0 ? (
              <tr>
                <td colSpan="6" style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-tertiary)' }}>No hay obras para mostrar con los filtros actuales.</td>
              </tr>
            ) : (
              obras.map(obra => (
                <tr 
